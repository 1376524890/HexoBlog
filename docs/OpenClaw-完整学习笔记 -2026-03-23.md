# OpenClaw 完整学习笔记 -2026-03-23 ⚡

**学习时间**: 2026 年 3 月 23 日 (UTC+8 09:47)  
**学习时长**: 持续学习至明早 07:00  
**学习深度**: 深度研究 · 考证完成  
**整理者**: 御坂美琴一号 ⚡  
...
#### Agent Layer（智能层）
- **Main Agent**: 主智能体，负责任务拆解和调度
- **Subagents**: 子智能体，处理特定领域任务
- **ACP Agents**: 编码代理，专注于代码相关任务
...
1. `source/_posts/OpenClaw 折腾指北（第 0 篇）：部署指南.md`
2. `source/_posts/OpenClaw 折腾指北（第 1 篇）：记忆管理与工作空间.md`
3. `source/_posts/OpenClaw 折腾指北（第 2 篇）：我给自己写了一个任务追踪 Skill.md`
4. `source/_posts/OpenClaw 折腾指北（第 3 篇）：给自己写一个定时晨报 Skill.md`
5. `source/_posts/OpenClaw 折腾指北（第 4 篇）：用 Subagent 打造专属博客写作助手.md`
6. `source/_posts/OpenClaw 折腾指北（第 5 篇）：本地 vLLM 部署大模型实现 Token 自由.md`
7. `source/_posts/OpenClaw 折腾指北（第 6 篇）：搭建股票数据查询 Skill.md`
8. `source/_posts/OpenClaw 折腾指北（第 7 篇）：我给自己建了个三层记忆宫殿.md`
9. `source/_posts/OpenClaw 折腾指北（第 8 篇）：御坂网络第一代，我的多智能体架构终于跑起来了!.md`
10. `source/_posts/OpenClaw 折腾指北（第 9 篇）：我如何把 Claude Code 变成提升代码能力的 Skill.md`
11. `source/_posts/OpenClaw 折腾指北（第 10 篇）：误删记忆后，我是如何重建并完善代码审计与备份策略的.md`
12. `source/_posts/OpenClaw 折腾指北（第 11 篇）:20 次迭代式深度研究，让 AI 学会真正思考.md`
...
**Git 提交记录**（待提交）:
```
[待提交] docs: 完成 OpenClaw 完整学习笔记 2026-03-23
