...
### Sandbox vs Tool Policy vs Elevated（关键区别）⭐⭐⭐⭐⭐

```
Sandbox（沙箱）
- 在哪里执行（where）
- 隔离级别（off/sandbox/agent/shared）
...
- `docs/OpenClaw-知识学习总结-2026-03-24.md` - 详细学习总结（今日）
...
**Git 提交建议**:
```bash
git add docs/OpenClaw-知识学习总结-2026-03-24.md docs/OpenClaw-汇报速查卡片-2026-03-25.md
