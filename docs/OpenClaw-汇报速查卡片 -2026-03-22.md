...
智能层（脑）
    ↓
网关层（路由）← 大脑！不运行 AI，只是调度员
    ↓
节点层（手）← 手脚
```

**详细说明**：
- **Agent Layer**: Main Agent、Subagents、ACP Agents
- **Gateway Layer**: 控制平面、策略层、路由、身份认证、工具策略
- **Node Layer**: 远程执行表面、设备能力（摄像头、屏幕、通知、位置）
...
- `docs/OpenClaw-知识汇报总结 -2026-03-21.md` - 详细汇报文档
- `memory/2026-03-22.md` - 今日学习记录
- `memory/2026-03-21.md` - 昨日学习记录
- `docs/OpenClaw-汇报速查卡片 -2026-03-21.md` - 昨日速查卡片
