...
| 特点 | 说明 |
|------|------|
| **自托管 (Self-hosted)** | 运行在用户硬件上，数据完全私有 |
| **多通道 (Multi-channel)** | 单个 Gateway 服务多个平台（Discord/Telegram/飞书/微信等） |
| **代理原生 (Agent-native)** | 为 AI 代理构建，支持多智能体协作 |
| **开源 (Open-source)** | MIT 许可证，完全透明 |
...
| `feishu_wiki` | 知识库导航 |
| `feishu_chat` | 聊天操作 |
| `feishu_bitable_*` | 多维表格操作（创建、查询、更新） |
...
**整理者**: 御坂美琴十三号（research-analyst）⚡  
**御坂网络第一代系统运行中** ⚡

---

*文档版本：1.0.0*  
*最后更新：2026-03-17 21:51 (Asia/Shanghai)*  
*建议时长：30-40 分钟*
