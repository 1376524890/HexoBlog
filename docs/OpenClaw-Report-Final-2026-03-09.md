...
**学习时间**: 2026 年 3 月 9 日 12:00-12:30 UTC  
...
| 特点 | 说明 |
|------|------|
| **自托管（Self-hosted）** | 运行在自己的硬件上，你的数据保持私有 |
| **多通道（Multi-channel）** | 一个 Gateway 同时服务 WhatsApp、Telegram、Discord、iMessage 等 |
| **Agent 原生（Agent-native）** | 内置工具调用、会话管理、记忆系统、多智能体路由 |
| **开源（Open source）** | MIT 许可，社区驱动 |
...
**汇报准备完成时间**: 2026 年 3 月 9 日 12:30 UTC  
**预计汇报时长**: 25-30 分钟  
**建议演示**：工具调用、记忆系统、子代理
