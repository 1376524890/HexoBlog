...
**当前时间**: 2026 年 3 月 14 日 10:43 AM (UTC+8)  
**整理者**: 御坂美琴一号 ⚡  
**状态**: ✅ **学习完成，汇报准备就绪**  
**剩余准备时间**: 已经过了原定汇报时间（系统任务执行中）
...
## 🏗️ 第三部分：多智能体路由机制（进阶知识）

### 什么是"一个 Agent"？

An **agent** 是一个完全隔离的大脑，具有自己的：
- **Workspace**（文件、AGENTS.md/SOUL.md/USER.md、本地笔记、人格规则）
- **State directory**（agentDir）用于认证配置文件、模型注册表
- **Session store**（chat history + routing state）在 `~/.openclaw/agents/<agentId>/sessions`
...
| 文档 | 字数 | 状态 |
|------|------|------|
| `docs/OpenClaw-知识汇报 -2026-03-14-最终版.md` | ~28.5KB | ✅ 已读 |
...
| 2️⃣ | 10 分钟 | 核心架构 | 三层架构 + 四组件 + Agent Loop + 多 Agent 路由 |
...
- `docs/OpenClaw-知识汇报 -2026-03-14-最终版.md` - 详细汇报文档
- `docs/OpenClaw-知识学习总结 -2026-03-12.md` - 深入学习总结
- `docs/OpenClaw-Quick-Cheat-Sheet.md` - 速查卡片
- `docs/GIT-WORKSPACE-GUIDE.md` - Git 工作空间指南
- `memory/2026-03-14.md` - 今日学习记录
- `MEMORY.md` - 精选记忆
