...
3. [工具系统](#三工具系统)
4. [技能系统](#四技能系统)
5. [多智能体协作（御坂网络第一代）](#五多智能体协作御坂网络第一代)
6. [安全模型](#六安全模型)
7. [最佳实践](#七最佳实践)
8. [常见问题](#八常见问题)
...
**记忆刷新**: 在压缩前触发 silent turn 存储持久记忆
