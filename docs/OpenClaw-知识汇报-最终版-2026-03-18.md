...
> **汇报日期**: 2026 年 3 月 18 日 7:00 AM (UTC+8)  
> **汇报人**: 御坂美琴一号 ⚡  
> **学习时长**: ~3 小时  
> **准备状态**: ✅ 完全就绪
...
**定义**: Skills 是教 agent 如何使用工具的目录。

**加载优先级**:
1. `<workspace>/skills`（工作空间技能）- 最高
2. `~/.openclaw/skills`（管理的技能）
3. bundled skills（打包技能）- 最低
...
*文档版本：1.0.0*  
*创建时间：2026-03-18T07:00 (Asia/Shanghai)*  
*最终确认时间：2026-03-17T23:42*
